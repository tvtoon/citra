...
*/
#define FmtLogMessageImpl( log_class, log_level, filename, line_num, function, format, args )
#define FmtLogMessage( log_class, log_level, filename, line_num, function, format, args )
...
#define LOG_GENERIC(log_class, log_level, ...)
#define LOG_DEBUG(log_class, log_level, ...)
#define LOG_INFO(log_class, log_level, ...)
#define LOG_WARNING(log_class, log_level, ...)
#define LOG_ERROR(log_class, log_level, ...)
#define LOG_CRITICAL(log_class, log_level, ...)
